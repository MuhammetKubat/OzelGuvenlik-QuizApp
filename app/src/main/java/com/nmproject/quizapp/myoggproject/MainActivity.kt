...
class MainActivity : AppCompatActivity() {
    ...
    fun option1Clicked(view: View): View {
        disableButton()
    ...
    fun option2Clicked(view: View): View {
        disableButton()
    ...
    fun option3Clicked(view: View): View {
        disableButton()
    ...
    fun option4Clicked(view: View): View {
        disableButton()
    ...
    fun option5Clicked(view: View): View {
        disableButton()
